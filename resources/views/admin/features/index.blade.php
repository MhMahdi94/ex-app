            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <h6 class="mb-0 text-uppercase ">{{ __('routes.Features') }}</h6>
                        ...
                        <div class="d-flex ustify-content-between align-items-center" width='200'>
                            <a class=" btn btn-primary float-right" href="{{ route('admin.landing.landing_features_create') }}">{{ __('routes.Add Feature') }}</a>
                        </div>
                                                 ...
                                                 <div class="mx-2">
                                                    {{-- @if(Auth::guard('admin')->user()->can('edit-role')) --}}
                                                        <a class="btn btn-warning px-4"
                                                            href="{{ route('admin.landing.landing_features_edit', $feature->id) }}">{{ __('routes.Edit') }}</a>
                                                    {{-- @endif --}}
                                                </div>
                                              {{--  <div class="">

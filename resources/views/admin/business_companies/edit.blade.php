                ...
                <form method="POST" action="../update/{{ $business_company->id }}" class='needs-validation' novalidate>
                    ...
                    <div class="card-body row g-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{ $business_company->name }}" class="form-control" id="name"  required>
                        </div>
                       
                        <div class="form-group">
                            <label for="email">{{ __('routes.Email') }}</label>
                            <input type="email" name="email" value="{{ $business_company->email }}" class="form-control" id="email"  required>
                        </div>
                        <div class="form-group">
                            <label for="mobile_no">{{ __('routes.Mobile No') }}</label>
                            <input type="text" name="mobile_no" value="{{ $business_company->mobile_no }}" class="form-control" id="mobile_no"  required>
                        </div>
                        {{--  --}}
                        <div class="row g-1">
                        ...
                        <div class="form-group">
                          ...
                          <textarea class="form-control" id="description"  name='description'   required>{{ $business_company->desc }}</textarea>
                        </div>

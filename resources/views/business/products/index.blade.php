            ...
            @foreach ($data as $item)
                <tr>
                  ...
                  <td class="row row-cols-auto ">
                      <div class="col-4">
                        <a class="btn btn-primary px-4" href="{{ route('business.products.products_edit',$item->id ) }}">Edit</a>
                      </div>
                        <div class="col-4">
                          <meta name="csrf-token" content="{{ csrf_token() }}">
                          <form method="post" class="delete-form" data-route="{{route('business.products.products_destroy', $item->id) }}">
                            @method('delete')

        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">{{ __('routes.Edit User') }}</h3>
                ...
                <form method="POST" action="../update/{{ $owner->id }}" class='needs-validation' novalidate>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="email" name="email" value="{{ $owner->email }}" class="form-control" id="email"  required>
                        </div>
                        <div class="form-group mb-2">
                            <label for="mobile_no">{{__('routes.Mobile No')}}</label>
                            <input type="text" name="mobile_no" value="{{ $owner->mobile_no }}" class="form-control" id="mobile_no"  required>
                        </div>

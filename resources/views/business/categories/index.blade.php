        ...
        <div class=" card">
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex ustify-content-between align-items-center" width='200'>
                        <a class=" btn btn-primary float-right" href="{{ route('business.categories.category_create') }}">Add
                            Category</a>
                    </div>
                </div>
            ...
            @foreach ($data as $item)
                <tr>
                  ...
                  <td class="row row-cols-auto ">
                      <div class="col-2">
                        <a class="btn btn-primary px-4" href="{{ route('business.categories.category_edit',$item->id ) }}">Edit</a>
                      </div>
                        <div class="col-2">

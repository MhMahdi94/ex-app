...
<div class="row">
    <div class="col-8">
        <div class="card h-max">
            <div class="card-header"><h6 class="mb-0 text-uppercase">{{__('routes.Attendence Sheet')  }}</h6></div>
    ...
    <div class="col-4">
        <div class="card ">
            <div class="card-header"><h6 class="mb-0 text-uppercase">{{__('routes.Leave Request')  }}</h6></div>
            <div class="card-body">
                <div class="card radius-15 bg-success">
                    <div class="card-body text-center">
                        <div class="p-4 radius-15">
    ...
    <div class="row">
        <div class="col"><div class="card px-2">
    ...
    @endphp
        ...
        <div class="col">
            <div class="card h-max">
                <div class="card-header"><h6 class="mb-0 text-uppercase">{{__('routes.Stock Managment')  }}</h6></div>
                <div class="card-body row">
                    <div class="col">

            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <h6 class="mb-0 text-uppercase ">{{ __('routes.Revenue') }}</h6>
                        ...
                        <div class="d-flex ustify-content-between align-items-center" width='200'>
                            @if (Auth::guard('employee')->user()->can('create-role'))
                                <a class=" btn btn-primary float-right" href="{{ route('company.revenues.revenue_create') }}">{{ __('routes.Add') }}</a>
                            @endif
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex ">
                                                <div class="mx-2">
                                                    ...
                                                    <a class="btn btn-warning px-4" href="{{ route('company.revenues.revenue_edit', $revenue->id) }}">{{ __('routes.Edit') }}</a>
                                                    @endif
                                                ...
                                                <div class="">
                                                    @if (Auth::guard('employee')->user()->can('delete-role'))
                                                        ...
                                                        <form method="post" class="delete-form"
                                                            data-route="{{ route('company.revenues.revenue_destroy', $revenue->id) }}">
                                                            @method('delete')

                    ...
                    <div class="card-header d-flex justify-content-between ">
                        ...
                        <ul class="nav nav-pills">
                            ...
                            <li class="nav-item"><a class="nav-link "
                                    href="{{ route('company.coa.coa_assets') }}">{{__('routes.Assets')}}</a></li>
                            <li class="nav-item"><a class="nav-link"
                                    href="{{ route('company.coa.coa_liabilities') }}">{{__('routes.Liabilities')}}</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('company.coa.coa_equity') }}">{{__('routes.Equity')}}</a>
                            </li>
                            <li class="nav-item"><a class="nav-link"
                                    href="{{ route('company.coa.coa_expenses') }}">{{__('routes.Expenses')}}</a></li>
                            <li class="nav-item"><a class="nav-link active"
                                    href="{{ route('company.coa.coa_revenue') }}">{{__('routes.Revenue')}}</a></li>
                        </ul>

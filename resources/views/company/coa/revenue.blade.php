                    ...
                    <div class="card-header d-flex justify-content-between ">
                        ...
                        <ul class="nav nav-pills">
                            ...
                            <li class="nav-item"><a class="nav-link "
                                    href="{{ route('company.coa.coa_assets') }}">Assets</a></li>
                            <li class="nav-item"><a class="nav-link"
                                    href="{{ route('company.coa.coa_liabilities') }}">Liabilities</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('company.coa.coa_equity') }}">Equity</a>
                            </li>
                            <li class="nav-item"><a class="nav-link"
                                    href="{{ route('company.coa.coa_expenses') }}">Expenses</a></li>
                            <li class="nav-item"><a class="nav-link active"
                                    href="{{ route('company.coa.coa_revenue') }}">Revenue</a></li>
                        </ul>
